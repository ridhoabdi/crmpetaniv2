  ...
  <div class="container">
    <div class="row align-items-center min-vh-75 min-vh-lg-100">
      <div class="col-md-7 col-lg-6 col-xxl-5 py-6 text-sm-start text-center">
        ...
        <p class="mb-4 fs-1">Program ini adalah prototype hasil Tugas Akhir yang berjudul "Perancangan Aplikasi Petani untuk Pengelolaan Data Bawang Merah dengan PostgreSQL"</p>
...
<section class="py-0" id="contact">
  ...
  <div class="container">
    ...
    <div class="row flex-center py-5">
      <div class="col-12 col-sm-8 col-md-6 text-center text-md-start"> <a class="text-decoration-none" href="#"><img class="d-inline-block align-top img-fluid" src="assets/img/gallery/logo-icon.png" alt="" width="20" /><span class="text-theme font-monospace fs-3 ps-2">CRM Petani</span></a></div>
      <div class="col-12 col-sm-8 col-md-6">
        <p class="fs--1 text-dark my-2 text-center text-md-end">&copy; Dibuat Oleh Team
          ...
          </svg><a class="text-dark" href="https://themewagon.com/" target="_blank">Center Of Exccellence UDINUS</a>
        </p>
      </div>
    </div>
  </div>
