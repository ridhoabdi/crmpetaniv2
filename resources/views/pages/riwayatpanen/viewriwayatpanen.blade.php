...
<div class="card p-3 shadow-sm">
    ...
    <ul class="list-group mt-3">
        <div class="card-header">
            <p class="" style="font-size: larger;">Berikut adalah riwayat panen dari kegiatan penanaman bawang merah yang telah Bapak/Ibu lakukan. <br> Silakan klik ikon <i class="menu-icon mdi mdi-download btn-outline-success mx-1"></i> unduh untuk melihat detail riwayat panen. </p>
        </div>
